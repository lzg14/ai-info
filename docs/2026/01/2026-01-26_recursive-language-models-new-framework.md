...
This approach represents a natural evolution from prompt engineering to optimizing how models manage their own memory. The code for RLM is currently available on GitHub. The researchers plan to integrate RLMs directly into DSPy, a popular framework for programming language models.
