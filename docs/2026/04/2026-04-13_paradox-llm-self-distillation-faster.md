<!--
{
  "title": "The paradox of LLM self-distillation: Faster reasoning, weaker generalization - TechTalks",
  "date": "2026-04-13",
  "source": "BD Tech Talks",
  "source_url": "https://bdtechtalks.com/2026/04/13/llm-self-distillation-tradeoffs/?utm_source=rss&utm_medium=rss&utm_campaign=llm-self-distillation-tradeoffs"
}
-->

# The paradox of LLM self-distillation: Faster reasoning, weaker generalization - TechTalks

📅 2026-04-13 | 📎 BD Tech Talks
...
## 相关文章
<!-- 相关文章开始 -->
- [Claude Code is leaking API keys into public package registries - TechTalks](2026-04-27_claude-code-leaking-api-keys.md)
<!-- 相关文章结束 -->
