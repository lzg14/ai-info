<!--
{
  "title": "Claude Code is leaking API keys into public package registries - TechTalks",
  "date": "2026-04-27",
  "source": "BD Tech Talks",
  "source_url": "https://bdtechtalks.com/2026/04/27/claude-code-api-token-leak/?utm_source=rss&utm_medium=rss&utm_campaign=claude-code-api-token-leak"
}
-->

# Claude Code is leaking API keys into public package registries - TechTalks

📅 2026-04-27 | 📎 BD Tech Talks
...
## 相关文章
<!-- 相关文章开始 -->
- [The paradox of LLM self-distillation: Faster reasoning, weaker generalization - TechTalks](2026-04-13_paradox-llm-self-distillation-faster.md)
<!-- 相关文章结束 -->
